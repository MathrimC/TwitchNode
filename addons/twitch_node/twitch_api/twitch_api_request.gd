...
enum APIOperation { GET_USER_INFO, GET_GAMES, SUBSCRIBE_TO_EVENT, UNSUBSCRIBE_FROM_EVENT, GET_EVENT_SUBSCRIPTIONS, POST_CHAT_MESSAGE, GET_CHANNEL_INFO, MODIFY_CHANNEL_INFO, GET_STREAMS, CREATE_POLL, SEND_SHOUTOUT, BAN_USER, GET_VIPS, ADD_VIP, REMOVE_VIP, GET_SUBS, GET_FOLLOWERS, GET_MODERATORS, CREATE_PREDICTION, END_PREDICTION, START_RAID, CANCEL_RAID, WARN_USER, GET_CUSTOM_REWARDS, CREATE_CUSTOM_REWARD, UPDATE_CUSTOM_REWARD, UPDATE_REDEMPTION_STATUS, SEND_CHAT_ANNOUNCEMENT, START_COMMERCIAL, GET_AD_SCHEDULE, SNOOZE_NEXT_AD }
...
const api_operations: Dictionary = {
	...
	APIOperation.UNSUBSCRIBE_FROM_EVENT: {
		"endpoint": "eventsub/subscriptions",
		"scope": "",
		"method": HTTPClient.METHOD_DELETE
	},
	APIOperation.GET_EVENT_SUBSCRIPTIONS: {
		"endpoint": "eventsub/subscriptions",
		"scope": "",
		"method": HTTPClient.METHOD_GET
	},
